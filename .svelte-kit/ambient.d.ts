...
declare module '$env/static/private' {
	...
	export const DEVOPS_TOKEN: string;
	...
	export const GITHUB_TOKEN_NVR: string;
	...
	export const DOCKER_SCAN_SUGGEST: string;
